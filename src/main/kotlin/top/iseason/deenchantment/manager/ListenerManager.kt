...
import top.iseason.deenchantment.listeners.controllers.*
import top.iseason.deenchantment.utils.ClassGetter
...
object ListenerManager {
    ...
    private fun registerEnchantments() {
        //自动注册附魔监听器
        val classGetter = ClassGetter(plugin, "top.iseason.deenchantment.listeners.enchantments")
