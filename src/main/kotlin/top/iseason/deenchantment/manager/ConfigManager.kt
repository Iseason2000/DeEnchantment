package top.iseason.deenchantment.manager
...
import top.iseason.deenchantment.utils.DeEnum
import top.iseason.deenchantment.utils.LogSender
import top.iseason.deenchantment.utils.kparser.ExpressionParser
import top.iseason.deenchantment.utils.runnables.TargetFinder


object ConfigManager {
    private lateinit var plugin: top.iseason.deenchantment.DeEnchantmentPlugin
    ...
    fun init(plugin: JavaPlugin) {
        this.plugin = plugin as top.iseason.deenchantment.DeEnchantmentPlugin
        reload()
        isInit = true
    }
